...
hyperparameter_defaults = dict(
    seed=0,
    dataset_name="lung_NCBI_noweight",
...
if dataset_name == "lung_NCBI_noweight":
    data_dir = Path("/root/autodl-tmp/hzdata/scdata")
    adata = sc.read(data_dir / "lung_organid_5000cells.h5ad")
    adata_test = sc.read(data_dir / "lung_organid_100cells.h5ad")
