...
import NCBI_noWeight as ncbi
from NCBI_noWeight.model import TransformerModel, AdversarialDiscriminator
from NCBI_noWeight.tokenizer import tokenize_and_pad_batch, random_mask_value
from NCBI_noWeight.loss import (
    masked_mse_loss,
    masked_relative_error,
    criterion_neg_log_bernoulli,
)
from NCBI_noWeight.tokenizer.gene_tokenizer import GeneVocab
from NCBI_noWeight.preprocess import Preprocessor
from NCBI_noWeight import SubsetsBatchSampler
from NCBI_noWeight.utils import set_seed, category_str2int, eval_scib_metrics
...
hyperparameter_defaults = dict(
    seed=0,
    dataset_name="optic2_NCBI_noweight",
...
if dataset_name == "optic2_NCBI_noweight":
    data_dir = Path("/root/autodl-tmp/hzdata/scdata")
    adata = sc.read(data_dir / "optic2_10000cells.h5ad")
    adata_test = sc.read(data_dir / "optic2_200cells.h5ad")
