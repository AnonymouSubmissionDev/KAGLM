...
hyperparameter_defaults = dict(
    seed=0,
    dataset_name="human_atlas_ncbi_kan",
...
if dataset_name == "human_atlas_ncbi_kan":
    data_dir = Path("/root/autodl-tmp/hzdata/scdata")
    adata = sc.read(data_dir / "human_sub2000_atlas.h5ad")
    adata_test = sc.read(data_dir / "human_sub500_atlas.h5ad")
